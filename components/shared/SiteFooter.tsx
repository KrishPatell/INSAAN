...
import { RevealOnScroll } from '../home2/RevealOnScroll';

interface SiteFooterProps {
  onContactClick?: () => void;
}

export const SiteFooter: React.FC<SiteFooterProps> = ({ onContactClick }) => {
  return (
    <RevealOnScroll as="footer" className="w-full bg-black text-white">
      <div className="max-w-content mx-auto px-4 md:px-8 pt-24 md:pt-[85px] pb-[75px]">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-14 md:gap-8 mb-20 md:mb-28">
          ...
          <div className="md:col-span-5">
            <Link to="/" aria-label="Insaan Global — Home">
              <Logo variant="light" />
            </Link>
          ...
          <div className="md:col-span-2 md:col-start-7">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/solutions" className="text-[15px] md:text-[17px] font-medium text-white/50 hover:text-white transition-colors">
                  Solutions
                </Link>
              </li>
              <li>
