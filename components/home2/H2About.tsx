        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            <RevealOnScroll delay={80}>
              <h2 className="text-[30.6px] md:text-6xl lg:text-[3.86rem] font-bold text-insaan-black leading-[1] tracking-tightest mb-8">
            ...
            <RevealOnScroll delay={360}>
              <button
                ...
                className="inline-flex items-center gap-3 text-insaan-black font-bold text-base group"
              >
