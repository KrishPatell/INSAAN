    ...
    <section id="companies" className="w-full py-28 md:py-40 scroll-mt-24">
      <div className="max-w-content mx-auto px-4 md:px-8">
        ...
        <RevealOnScroll delay={80}>
          <h2 className="text-[36px] md:text-6xl lg:text-[4.2rem] font-bold text-insaan-black leading-[1] md:leading-[0.95] tracking-tightest mb-16 md:mb-20 max-w-3xl">
            Solutions ready for
            <br />
          ...
          {COMPANIES.map((company, i) => (
            <RevealOnScroll key={i} delay={160 + i * 120}>
              <div className="group relative bg-white rounded-3xl border border-insaan-black/[0.06] p-8 md:p-10 transition-all duration-500 hover:shadow-xl hover:shadow-insaan-black/[0.04] hover:-translate-y-1 overflow-hidden h-full flex flex-col">
                ...
                {/* Logo */}
                <div className="flex items-center justify-center h-[140px] md:h-[200px] mb-8 flex-shrink-0">
                  <img
                    src={company.logo}
