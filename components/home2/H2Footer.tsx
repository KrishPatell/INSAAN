      ...
      <div className="max-w-content mx-auto px-4 md:px-8 pt-24 md:pt-32 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-14 md:gap-8 mb-20 md:mb-28">
          ...
          <div className="md:col-span-2 md:col-start-7">
            <h4 className="text-[11px] font-bold tracking-[0.2em] uppercase text-white/25 mb-6">
              Company
            </h4>
            <ul className="space-y-4">
              ...
              <li>
                <button
                  ...
                  className="text-[15px] text-white/50 hover:text-white transition-colors text-left"
                >
                  Contact Us
                </button>
              </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 text-[15px] text-white/50 hover:text-white transition-colors"
                >
              ...
              <li>
                <a
                  ...
                  className="text-[15px] text-white/70 font-medium hover:text-[#59CBE8] transition-colors"
                >
        ...
        {/* Divider + bottom bar */}
        <div className="border-t border-white/[0.06] pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-3 text-[13px] text-white/25">
