            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-[17px] font-medium text-white/50 hover:text-white transition-colors"
                >
                  About Us
                </a>
              </li>
              ...
              <li>
                <button
                  ...
                  className="text-[17px] font-medium text-white/50 hover:text-white transition-colors text-left"
                >
                  Contact Us
                </button>
              </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 text-[17px] font-medium text-white/50 hover:text-white transition-colors"
                >
              ...
              <li>
                <a
                  ...
                  className="text-[17px] font-medium text-white/70 hover:text-[#59CBE8] transition-colors"
                >
