          ...
          <div className="max-w-content mx-auto px-4 md:px-8">
            ...
            <div className="reveal is-visible flex flex-col sm:flex-row gap-4" style={{ transitionDelay: '300ms' }}>
              ...
              <button
                ...
                className="px-6 py-3 md:px-8 md:py-4 border-2 border-insaan-black/15 text-insaan-black text-[13.5px] md:text-[15px] font-bold rounded-2xl hover:border-insaan-black/40 bg-white/50 backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5"
              >
                Get in Touch
              </button>
            </div>
